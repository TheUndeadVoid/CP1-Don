...
namespace BeautyTests
{
    public class BookingUpForBeautyTests
    {
        ...
        public void Schedule_date_using_only_numbers()
        {
            ...
            Assert.Equal(new DateTime(2019, 07, 25, 13, 45, 0), Appointment.Schedule("25/7/2019 13:45:00"));
        }
        ...
        {
            Assert.Equal("You have an appointment on 29/03/2019 3:00:00 PM.", Appointment.Description(new DateTime(2019, 03, 29, 15, 0, 0)));
        }

        [Fact]
        public void Description_on_thursday_afternoon()
        {
            Assert.Equal("You have an appointment on 25/07/2019 1:45:00 PM.", Appointment.Description(new DateTime(2019, 07, 25, 13, 45, 0)));
        }

        [Fact]
        public void Description_on_wednesday_morning()
        {
            Assert.Equal("You have an appointment on 09/09/2020 9:09:09 AM.", Appointment.Description(new DateTime(2020, 9, 9, 9, 9, 9)));
        }
